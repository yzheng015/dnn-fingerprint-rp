...
def main():
	...
	with open('./log.txt', 'a') as f:
		...
		f.write('model name: wp_cifar100-{}\n'.format(model_name))
		f.write('frac: {}/10\n'.format(frac1))
...
# Train and evaluate
	...
	saved_PATH = "./saved_models/cifar100_"+model_name+"_wp/"
...
if __name__ == "__main__":
	...
	model_name_list = ['densenet161']
	#frac1_list = [8]
	#for i in range(len(model_name_list)):
	for model_name in model_name_list:
		for frac1 in range(4,9):
	#	model_name = model_name_list[i]
	#	frac1 = frac1_list[i]
			print('Start Weight Pruning cifar100-'+ model_name+'......')
			main()
