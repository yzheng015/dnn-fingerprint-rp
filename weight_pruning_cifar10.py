...
def main():
	...
	with open('./log.txt', 'a') as f:
		f.write('-----'*10+'\n')
		f.write(start+'--weight pruning--\n')
		f.write('model name: wp_cifar10-{}\n'.format(model_name))
		f.write('frac: {}/10\n'.format(frac1))
...
# Train and evaluate
	...
	print("weight pruning frac: "+str(frac1)+"/10\n")
	saved_PATH = "./saved_models/cifar10_"+model_name+"_wp/"
	if a:
...
if __name__ == "__main__":
	...
	model_name_list = ['resnet20', 'resnet20','resnet20', 'resnet20','resnet20', 'resnet20','resnet20', 'resnet20']
	frac1_list = [1, 2,3,4,5,6,7,8]
	for i in range(len(model_name_list)):
		model_name = model_name_list[i]
		frac1 = frac1_list[i]
		print('Start Weight Pruning cifar10-'+ model_name+'......')
		main()
