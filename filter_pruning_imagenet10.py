'''Obtain pirated model by filter pruning
...
# Train and evaluate
	...
	print("frac: "+str(frac1)+"\n")
	saved_PATH = "./saved_models/imagenet10_"+model_name+"_fp/"
...
if __name__ == "__main__":
	...
	#model_name = input('Model to be tested: ')
	#frac1 = int(input('frac 1-16: '))
	#model_name_list = ['resnet18', 'vgg11', 'densenet161']
	model_name_list = ['vgg11']
	frac1_list = [12]
